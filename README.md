...
The project aims to capture spoken audio from both the user and the meeting environment, transcribe it, translate it into a chosen target language, and output it as either captions, synthesized speech, or both.

The long-term vision for Conduit is a background desktop assistant that feels automatic, low-friction, and reliable. It should run quietly in the system tray, work across major desktop operating systems, support live multilingual conversations, and preserve a natural speaking experience through low-latency processing and optional voice synthesis.
